...
module.exports = {
    name: 'unmute',
    description: "unmutes person from server",
    async execute(message,args){
        ...
        message.guild.members.cache.get(member.id).roles.add(`760091557520080906`);

        message.guild.members.cache.get(member.id).roles.remove(`745116515891937322`);
